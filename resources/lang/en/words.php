...
return [
    ...
    'team' => [
        ...
        'sergey' => [
            ...
            'p2' => 'Leading and motivating subordinates to advance employee engagement develop a high performing managerial team.',
            'p3' => 'Overseeing all operations and business activities to ensure they produce the desired results and are consistent with the overall strategy and mission.',
        ],
        'viktor' => [
            'name' => 'Viktor Garkusha',
            'p1' => 'Work with the CEO and other executives to develop a technical strategy for the company.',
            'p2' => 'Aids recruitment and retention efforts, streamlines production operations, and advocates for innovative ideas, high production, and individual on the team.',
            'p3' => 'Maximizes the efficiency of production efforts by coordinating the various teams and operations involved in the process and ensuring there is no overlap.',
        ],
        'yaroslav' => [
            'name' => 'Yaroslav Chanyzh',
    ...
    'contacts' => [
        'title' => 'Get In Touch',
        'chat' => 'Chat on Skype',
        'address' => 'Ukraine, Kyiv, Elektrotehnichna street',
        'email' => 'Send us email',
    ],
    'footer' => [
